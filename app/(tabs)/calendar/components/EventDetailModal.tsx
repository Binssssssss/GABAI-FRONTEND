  ...
  return (
    ...
    >
      <View style={styles.modalOverlay}>
        <View
          style={[styles.detailModalContainer, { backgroundColor: cardTheme }]}
        >
          {/* Modal Header Ribbon */}
          <View
            style={[
              styles.modalHeaderRibbon,
          ...
          >
            ...
            <Text style={[styles.modalTitleText, { color: textTheme }]}>
              {event.title}
            </Text>
            ...
            {event.description ? (
              <View style={styles.modalDescContainer}>
                <Text style={[styles.descTitle, { color: textSubTheme }]}>
                  Description
                </Text>
                <Text style={[styles.descBodyText, { color: textTheme }]}>
                  {event.description}
                </Text>
              </View>
            ) : null}
            ...
            {event.checklist.length > 0 ? (
              <View style={styles.modalChecklistContainer}>
                <Text
                  style={[styles.checklistTitleText, { color: textSubTheme }]}
                >
            ...
            <View style={styles.modalActionButtonsRow}>
              <TouchableOpacity
                style={[
                  styles.actionBtn,
                  { borderColor: borderTheme, borderWidth: 1 },
                ]}
